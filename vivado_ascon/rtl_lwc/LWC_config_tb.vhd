...
package LWC_config_tb is
    ...
    CONSTANT G_FNAME_PDI : string   := "/tmp/ascon_hw/hardware/ascon_lwc/KAT/v1/pdi.txt";
    CONSTANT G_FNAME_SDI : string   := "/tmp/ascon_hw/hardware/ascon_lwc/KAT/v1/sdi.txt";
    CONSTANT G_FNAME_DO  : string   := "/tmp/ascon_hw/hardware/ascon_lwc/KAT/v1/do.txt";
    CONSTANT G_FNAME_RDI : string   := "";
